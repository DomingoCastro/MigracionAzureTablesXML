...
namespace MigracionAzureTablesXML
{
    public partial class Form1 : Form
    {
        ...
        private async void botonMigrar_Click(object sender, EventArgs e)
        {
            ...
            string connectionString = "DefaultEndpointsProtocol=https;AccountName=storageeoidomi;AccountKey=Mj+gagPVpCGP+jr45vNqHZntZTBr+wFw0cWU25K2x2RGRhH0WUk+Ob0BuGdA3yI2k+wJxge8+/2w+AStx4sxgg==;EndpointSuffix=core.windows.net";
